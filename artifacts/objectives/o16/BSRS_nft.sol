...
// file: ERC721PresetMinterPauserAutoId.sol
// file: ERC721.sol
// file: IERC721.sol
// file: IERC165.sol
/**
    ...
    ERC721Pausable
{
    ...
    function presale_mint(
        ...
        require(
            verify(leaf, _root, _proof),
            "You are not on our pre-sale allow list!"
        );
        _mint(to, _tokenIdTracker.current());
        _tokenIdTracker.increment();
    }
...
contract BSRS is ERC721PresetMinterPauserAutoId {
    constructor()
        public
        ERC721PresetMinterPauserAutoId(
            "Bored Sporc Rowboat Society",
            "BSRS",
            "https://boredsporcrowboatsociety.com/TOKENS/BSRS"
        )
    {}
}
