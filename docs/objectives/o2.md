...
??? hint "Terminal Hint #1"
    Each question may have hints. If you want another hint from the elf, just type `hint` in the upper pane.

??? hint "Terminal Hint #2"
    If you need help with Wireshark filters you can [go here](https://www.cellstream.com/resources/2013-09-10-11-55-21/cellstream-public-documents/wireshark-related/83-wireshark-display-filter-cheat-sheet/file).

??? hint "Terminal Hint #3"
    If you need help with tshark filters, try [this cheat sheet](https://cheatography.com/mbwalker/cheat-sheets/tshark-wireshark-command-line/).

??? hint "Terminal Hint #4"
    Of course, SANS has lots of [cheat sheets](https://www.sans.org/blog/the-ultimate-list-of-sans-cheat-sheets/) that can help.

??? hint "Terminal Hint #5"
    And remember, you can use Wireshark filters in tshark.
...
Wireshark's `File > Export Objects` menu provides an overview of all the different object types that can be exported.
